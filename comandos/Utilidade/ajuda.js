...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        let embed_imagem = new Discord.EmbedBuilder()
            ...
            .setAuthor({ name: interaction.user.username, iconURL: interaction.user.displayAvatarURL({ dynmiac: true }) })
            .setDescription(`
            > \`/passed\` Aplica o efeito 'passed' a uma imagem de perfil, estilo GTA
            > \`/stonks\` Cria uma imagem do meme stonks!
            > \`/triggered\` Aplica o efeito 'triggered' a uma imagem de perfil.
            > \`/tweet\` Cria um tweet falso
            > \`/wasted\` Aplica o efeito 'Wasted' a uma imagem de perfil, estilo do GTA.
            > \`/xbox\` Desbloqueie uma conquista do Xbox.
